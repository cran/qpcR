...
DAT2 <- pcrbatch(reps, fluo = 2:7, model = l5)
...
DAT3 <- pcrbatch(reps, fluo = 2:19, model = l5)
...
DAT4 <- pcrbatch(reps, fluo = 2:19, do.mak = TRUE)
GROUP4 <- c("r1c1", "r1c1", "r2c1", "r2c1", "g1c1", "g1c1",
           "r1s1", "r1s1", "r1s2", "r1s2", "r2s1", "r2s1",
           "r2s2", "r2s2", "g1s1", "g1s1", "g1s2", "g1s2")
res4 <- ratiobatch(DAT4, GROUP4, which.eff = "mak", 
                  type.eff = "individual")
