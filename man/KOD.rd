...
\arguments{
  ...
  \item{method}{which method to use for kinetic outlier identification. Method from Bar et al. (2003) is default. See 'Details' for all methods.}
...
\deqn{\left(\frac{d^3F(x;a,b,...)}{dx^3} = 0\right) - \left(\frac{d^2F(x;a,b...)}{dx^2} = 0\right) < 10}
...
\deqn{\frac{dF(x;a,b,...)}{dx}, F\left(\frac{d^2F(x;a,b,...)}{dx^2} = 0\right), F_{max}}
